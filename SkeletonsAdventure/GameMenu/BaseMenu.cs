...
namespace SkeletonsAdventure.GameMenu
{
    ...
    {
        public ControlManager ControlManager { get; set; } = new(GameManager.FontsLibrary.Arial20);
        ...
        public Texture2D Texture { get; set; } = GameManager.TexturesLibrary.GameMenuTexture;
